 ...
 *   Check for existing email
 * ********************* */
async function checkExistingEmailExlusive(account_email, account_id){
  try {
    const sql = "SELECT * FROM account WHERE account_email = $1 AND NOT account_id = $2"
...
async function updateAccountDetails(account_id, account_firstname, account_lastname, account_email) {
  ...
  try {
    ...
    return new Error("Unable to update account details")
  }
}
